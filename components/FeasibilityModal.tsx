            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    <h3 className="text-lg font-bold text-gray-900">
                        {isHighRisk ? '行程可能無法實現' : '行程安排建議'}
                    </h3>
                    <p className="text-sm text-gray-500 mt-0.5">
                        AI 檢測到您的變更可能會導致行程過於緊湊或不合理。
                    </p>
                </div>
            </div>
        ...
        <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            {result.issues.length > 0 && (
                <div className="space-y-3">
                    <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">潛在問題</h4>
            ...
            {result.suggestions.length > 0 && (
                <div className="space-y-3">
                    <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">建議調整方向</h4>
                    <div className="space-y-2">
